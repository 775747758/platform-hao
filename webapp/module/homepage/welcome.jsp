		...
		<div id="login_container">
			<uc:form id="${pageId}welcomeForm" cssClass="box" method="post" action="${path}/j_spring_security_check">
				...
				<div class="username_container">
					...
					<input class="username" type="text" id="${pageId}loginName" placeholder="用户名" tabindex="1" name="j_username" value=""/>
				</div>
				<div class="pass_container">
					<img src="${path}/platform/theme/distributionSystem/images/passworld.png">
					<input class="pass" type="password" id="${pageId}password" placeholder="密码" tabindex="2" name="j_password" value=""/>
				</div>
						...
						<div class="loginform">
							<uc:form id="${pageId}welcomeForm" cssClass="ztag" method="post" action="${path}/j_spring_security_check">
								...
								<ul>
									...
									<li><input class="input" type="text" id="${pageId}loginName" placeholder="用户名" tabindex="1" name="j_username" value=""/></li>
									<li><input class="input" type="password" id="${pageId}password" placeholder="密码" tabindex="2" name="j_password" value=""/></li>
									<li class="yanzheng">
