	...
	<head>  
		<script type="text/javascript">
			...
			com.yunt.user.list = {
				...
				initMenuById : function(id) {
				confirm("确定要初始化吗？",function(){
					$.ajax({
					 	type: "POST",
					 	url: "${path}/weChat/initMenuById?userId="+id,
					  	processData:true,
					  	success: function(data){
					  		$.successTips();
						...
						<c:if test="${i.index%2 eq 0}">
							<tr class="a1">
								...
								<td>
									...
									<input type="button" value="初始化菜单" class="btn" onclick="com.yunt.user.list.initMenuById('${user.id}');" />
								</td>
							</tr>
						</c:if>
