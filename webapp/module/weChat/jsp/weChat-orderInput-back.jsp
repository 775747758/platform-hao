...
<meta name="viewport
	content="width=320,user-scalable=no,target-densitydpi=medium-dpi" />
<meta name="viewport"
	content="width=device-width,user-scalable=no,target-densitydpi=medium-dpi" />
<link
	href="${path}/platform/theme/default/component/bootstrap/css/bootstrap.min.css"
	type="text/css" rel="stylesheet">
<link href="${path}/platform/theme/distributionSystem/css/clearing.css"
	type="text/css" rel="stylesheet">
<title>结算中心</title>
...
<body>
	...
	<div class="clearing-header">
		<a
			href="${path}/weChat/shoppingCart?customerId=${shoppingCartVo.customer.id}"><span
			class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></a> <span
			class="title">结算中心</span>
	</div>
	<!---->
	<div class="shipping-address">
		<div class="address-header">收货地址</div>
		<div class="contacts">
			<img src="${path}/platform/theme/distributionSystem/images/men.png" />收货人<input
				type="text" id="receiver" class="shoping-text">
		</div>
		<div class="contacts">
			<img src="${path}/platform/theme/distributionSystem/images/mic.png" />手机号码<input
				type="text" id="receiverPhoneNum" class="shoping-text">
		</div>
		<div class="contacts">
			<img src="${path}/platform/theme/distributionSystem/images/pin.png" />详细地址<input
				type="text" id="receiveAddress" class="shoping-text">
		</div>
	</div>
	<!--购物单-->
	<div class="clearing-list">
		...
		<c:forEach items="${shoppingCartVo.shoppingCartList}"
			...
			<div class="clearing-product">
				<img src="${path}/platform/images/${shoppingCart.goods.picUrls[0]}"
					class="clearing-img">
	...
	<div class="clearing-shipment">
		<span class="shipment">运费</span> <span id='freight' class="clearing-reduce">快递：￥${freight }</span>
	</div>
	<c:if test="${shoppingCartVo.customer.user.discount ne ''}">
		<div class="clearing-calculate">
			<span class="clearing-total">折扣</span> <span class="total-money">${shoppingCartVo.customer.user.discount/10}折</span>
		</div>
	</c:if>
	...
	<div class="item-settlement">
		<div class="item-information">
			...
			<div class="total-price">
				合计<span id="bbb" class="item-price">&nbsp;￥${totalPrice}</span>
			</div>
