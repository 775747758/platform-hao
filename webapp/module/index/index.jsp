	...
	<body>
	    ...
	    <div class="content clearfix">
	        ...
	        <div class="menu">
	            <div class="cont">
	                <ul class="mList">
	                		<li onclick="com.yunt.index.loadContent('${path}/type/index');" class="left_list_selected">
	                        <img src="${path}/platform/theme/distributionSystem/images/home.png">类别管理
	                    </li>
	                    ...
	                    <li onclick="com.yunt.index.loadContent('${path}/advertisement/index')">
	                        <img src="${path}/platform/theme/distributionSystem/images/coin5.png">广告管理
	                    </li>
	                    ...
	                    <c:if test="${user.username=='administrator'}">
	                    ...
	                    <li onclick="com.yunt.index.loadContent('${path}/freight/index')">
	                        <img src="${path}/platform/theme/distributionSystem/images/coin4.png">运费管理
	                    </li>
	                </ul>
	            </div>
	        </div>
