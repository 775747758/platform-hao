	...
	<head>  
		<script type="text/javascript">
			...
			com.yunt.order.index = {
				...
				refresh : function () {
					com.yunt.order.index.loadContent("${path}/order/list?model.code="+$("#${pageId}code").val()+"&model.startDate="+ $("#${pageId}startDate").val()+"&model.endDate="+$("#${pageId}endDate").val()+"&model.state="+$("#${pageId}state").val());
				}
			};
